...
class LoneWerewolfDoneView extends StatefulWidget {
  const LoneWerewolfDoneView({super.key});

  @override
  State<LoneWerewolfDoneView> createState() => _LoneWerewolfDoneViewState();
}

class _LoneWerewolfDoneViewState extends State<LoneWerewolfDoneView> {
  String username = "";
  ...
  Widget _centerCard(data, index) {
    ...
    if (targetIndex == index) {
      if (targetRoleName == "troublemaker") targetRoleName = "trouble\nmaker";
